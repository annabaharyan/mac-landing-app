...
export const performanceImgPositionsDesktop = [
  {
    id: "p1",
    left: 5,
    bottom: 65,
...
export const performanceImgPositionsMobile = [
  { id: "p1", left: 20, bottom: 50 },
  { id: "p2", right: 20, bottom: 45 },
  { id: "p3", right: 10, bottom: 30 },
  { id: "p4", right: 0, bottom: 10 },
  { id: "p5", left: 30, bottom: 40 },
  { id: "p6", left: 15, bottom: 20 },
  { id: "p7", left: 10, bottom: 5 },
];
...
export const featureSequence = [
  {
    videoPath: `${import.meta.env.BASE_URL}/videos/feature-1.mp4`,
    boxClass: ".box1",
    delay: 1,
  },
  {
    videoPath: `${import.meta.env.BASE_URL}/videos/feature-2.mp4`,
    boxClass: ".box2",
    delay: 0,
  },
  {
    videoPath: `${import.meta.env.BASE_URL}/videos/feature-3.mp4`,
    boxClass: ".box3",
    delay: 0,
  },
  {
    videoPath: `${import.meta.env.BASE_URL}/videos/feature-4.mp4`,
    boxClass: ".box4",
    delay: 0,
  },
  {
    videoPath: `${import.meta.env.BASE_URL}/videos/feature-5.mp4`,
    boxClass: ".box5",
    delay: 0,
  },
];
